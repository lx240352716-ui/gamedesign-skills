...
# ============================================================
# [SHELVED] on_enter: wireframe — UI generation paused
# ============================================================
# The entire wireframe/Stitch integration has been shelved.
# To restore, see git history for the original on_enter_wireframe() function.

def on_enter_wireframe():
    """[SHELVED] Wireframe generation disabled."""
    print('[i] wireframe: feature shelved, skipping')
    return {
        "trigger": "wireframed",
        "screenshots": [],
        "message": "[i] wireframe feature shelved",
    }
...
def on_enter_export():
    ...
    # [SHELVED] wireframe copy disabled
...
# ============================================================
# [SHELVED] UI/Stitch helper functions removed
# See git history to restore: _extract_ui_sections, _load_stitch_api_key,
# _build_stitch_prompt, _extract_screenshot_url, _download_file, _extract_nested
# ============================================================
